YL.render = function (data) {
  ...
  YL.vue = new Vue({
    ...
    created: function () {
      ...
      console.log('%c' + YL.static.welcome, "color:blue;font-weight:bold;");//welcome
    },
    methods: {
      ...
      desktopContextMenu: function (e) {
        ...
        var menu = [
          ...
          [YL.util.getStrFa('image') + YL.lang("Wallpaper"), function () {
            YL.open('lightapt-system', { data: { nav: 'wallpaper' } })
          }, !YL.static.changeable],
          [YL.util.getStrFa('cog') + YL.lang("SystemOptions"), function () {
            YL.open('lightapt-system')
          }, !YL.static.changeable],
          '|',
          ...
          [YL.util.getStrFa('redo') + YL.lang("Reload"), function () {
            YL.f5();
          }],
          '|',
      ...
      btnShortSettingAdvanceClick: function (appId) {
        ...
        YL.open('lightapt-system', { data: { appSetting: appId } })
      },
