...
void load_url(){
    ...
    ([]{
        auto page = crow::mustache::load_text("ndesktop.html");
        return page;
    });

    CROW_ROUTE(app, "/ndesktop-browser")
    ([]{
        auto page = crow::mustache::load_text("ndesktop-browser.html");
        return page;
    });

    CROW_ROUTE(app, "/ndesktop-store")
    ([]{
        auto page = crow::mustache::load_text("ndesktop-store.html");
        return page;
    });

    CROW_ROUTE(app, "/ndesktop-system")
    ([]{
        auto page = crow::mustache::load_text("ndesktop-system.html");
        return page;
    });
