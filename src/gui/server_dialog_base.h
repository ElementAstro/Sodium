...
class ServerDialog : public wxDialog
{
	...
	public:
		...
		ServerDialog( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("ServerDialog"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = wxDEFAULT_DIALOG_STYLE );
