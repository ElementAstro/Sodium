...
protected:
    ...
    virtual void on_solver_changed(wxFileDirPickerEvent& event) {
        event.Skip();
    }
    ...
    virtual void check_template_downloaded(wxCommandEvent& event) {
        event.Skip();
    }
    ...
    virtual void on_open_template_folder(wxCommandEvent& event) {
        event.Skip();
    }
    ...
    virtual void on_copy_solver_result_dec(wxMouseEvent& event) {
        event.Skip();
    }
    virtual void on_copy_solver_result_rotation(wxMouseEvent& event) {
        event.Skip();
    }
    virtual void on_copy_solver_result_fovx(wxMouseEvent& event) {
        event.Skip();
    }
    virtual void on_copy_solver_result_fovy(wxMouseEvent& event) {
        event.Skip();
    }

public:
    SolverAssistant(wxWindow* parent, wxWindowID id = wxID_ANY,
                    const wxString& title = _("SolverAssistant"),
