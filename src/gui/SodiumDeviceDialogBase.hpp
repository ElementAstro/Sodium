...
protected:
    ...
    virtual void on_camera_settings_click(wxCommandEvent& event) {
        event.Skip();
    }
    virtual void on_camera_connect_click(wxCommandEvent& event) {
        event.Skip();
    }
...
public:
    DeviceDialog();
    DeviceDialog(wxWindow* parent, wxWindowID id = wxID_ANY,
                 const wxString& title = _("OpenAPT Client"),
