...
DeviceDialog::DeviceDialog(wxWindow* parent, wxWindowID id,
                           const wxString& title, const wxPoint& pos,
                           const wxSize& size, long style) {
    this->Create(parent, id, title, pos, size, style);
}

bool DeviceDialog::Create(wxWindow* parent, wxWindowID id,
                          const wxString& title, const wxPoint& pos,
                          const wxSize& size, long style) {
    ...
    m_main_listbook = new wxListbook(this, wxID_ANY, wxDefaultPosition,
                                     wxDefaultSize, wxLB_DEFAULT);
    m_mgr.AddPane(m_main_listbook, wxAuiPaneInfo()
                                       .Left()
    ...
    m_camera_panel = new wxPanel(m_main_listbook, wxID_ANY, wxDefaultPosition,
    ...
    m_camera_title = new wxStaticText(m_camera_panel, wxID_ANY, _("Camera"),
    ...
    int m_camera_choiceNChoices =
        sizeof(m_camera_choiceChoices) / sizeof(wxString);
    m_camera_choice =
        new wxChoice(m_camera_panel, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                     m_camera_choiceNChoices, m_camera_choiceChoices, 0);
    m_camera_choice->SetSelection(0);
    m_camera_connect_sizer->Add(m_camera_choice, 0, wxALL, 5);

    m_camera_settings_btn =
        new wxBitmapButton(m_camera_panel, wxID_ANY, wxNullBitmap,
    ...
    m_staticline11 =
        new wxStaticLine(m_camera_panel, wxID_ANY, wxDefaultPosition,
    ...
    m_camera_name_t = new wxStaticText(m_camera_panel, wxID_ANY, _("Name"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_camera_name_t->Wrap(-1);
    m_camera_name_sizer->Add(m_camera_name_t, wxGBPosition(0, 0),
                             wxGBSpan(1, 1), wxALL, 5);

    m_camera_name = new wxStaticText(m_camera_panel, wxID_ANY, wxEmptyString,
                                     wxDefaultPosition, wxDefaultSize, 0);
    m_camera_name->Wrap(-1);
    m_camera_name_sizer->Add(m_camera_name, wxGBPosition(0, 1), wxGBSpan(1, 1),
                             wxALL, 5);
    ...
    m_camera_description_sizer->SetNonFlexibleGrowMode(
        wxFLEX_GROWMODE_SPECIFIED);

    m_camera_description_t =
        new wxStaticText(m_camera_panel, wxID_ANY, _("Description"),
                         wxDefaultPosition, wxDefaultSize, 0);
    m_camera_description_t->Wrap(-1);
    m_camera_description_sizer->Add(m_camera_description_t, wxGBPosition(0, 0),
                                    wxGBSpan(1, 1), wxALL, 5);

    m_camera_description =
        new wxStaticText(m_camera_panel, wxID_ANY, wxEmptyString,
                         wxDefaultPosition, wxDefaultSize, 0);
    m_camera_description->Wrap(-1);
    m_camera_description_sizer->Add(m_camera_description, wxGBPosition(0, 1),
                                    wxGBSpan(1, 1), wxALL, 5);
    ...
    m_camera_gain_t = new wxStaticText(m_camera_panel, wxID_ANY, _("Gain"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_camera_gain_t->Wrap(-1);
    m_camera_info_sizer->Add(m_camera_gain_t, 0, wxALL, 5);

    m_camera_gain = new wxTextCtrl(m_camera_panel, wxID_ANY, wxEmptyString,
                                   wxDefaultPosition, wxDefaultSize, 0);
#ifdef __WXGTK__
    ...
    m_camera_offset_t = new wxStaticText(m_camera_panel, wxID_ANY, _("Offset"),
                                         wxDefaultPosition, wxDefaultSize, 0);
    m_camera_offset_t->Wrap(-1);
    m_camera_info_sizer->Add(m_camera_offset_t, 0, wxALL, 5);

    m_camera_offset = new wxTextCtrl(m_camera_panel, wxID_ANY, wxEmptyString,
                                     wxDefaultPosition, wxDefaultSize, 0);
#ifdef __WXGTK__
    ...
    m_camera_bin_t = new wxStaticText(m_camera_panel, wxID_ANY, _("Bin"),
                                      wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_camera_temperature_title =
        new wxStaticText(m_camera_panel, wxID_ANY, _("Temperature Graph"),
                         wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_panel7 = new wxPanel(m_camera_panel, wxID_ANY, wxDefaultPosition,
                           wxDefaultSize, wxTAB_TRAVERSAL);
    ...
    m_telescope_panel =
        new wxPanel(m_main_listbook, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                    wxTAB_TRAVERSAL);
    wxBoxSizer* bSizer12;
    ...
    m_staticText321 =
        new wxStaticText(m_telescope_panel, wxID_ANY, _("Telescope"),
                         wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_choice41 =
        new wxChoice(m_telescope_panel, wxID_ANY, wxDefaultPosition,
                     wxDefaultSize, m_choice41NChoices, m_choice41Choices, 0);
    m_choice41->SetSelection(0);
    fgSizer241->Add(m_choice41, 0, wxALL, 5);

    m_bpButton21 =
        new wxBitmapButton(m_telescope_panel, wxID_ANY, wxNullBitmap,
                           wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW | 0);
    ...
    m_staticline111 =
        new wxStaticLine(m_telescope_panel, wxID_ANY, wxDefaultPosition,
                         wxDefaultSize, wxLI_HORIZONTAL);
    ...
    m_staticText711 = new wxStaticText(m_telescope_panel, wxID_ANY, _("Name"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText711->Wrap(-1);
    gbSizer31->Add(m_staticText711, wxGBPosition(0, 0), wxGBSpan(1, 1), wxALL,
                   5);

    m_staticText721 =
        new wxStaticText(m_telescope_panel, wxID_ANY, _("Simulator"),
                         wxDefaultPosition, wxDefaultSize, 0);
    m_staticText721->Wrap(-1);
    gbSizer31->Add(m_staticText721, wxGBPosition(0, 1), wxGBSpan(1, 1), wxALL,
                   5);
    ...
    m_staticText691 =
        new wxStaticText(m_telescope_panel, wxID_ANY, _("Description"),
                         wxDefaultPosition, wxDefaultSize, 0);
    m_staticText691->Wrap(-1);
    gbSizer51->Add(m_staticText691, wxGBPosition(0, 0), wxGBSpan(1, 1), wxALL,
                   5);

    m_staticText701 = new wxStaticText(m_telescope_panel, wxID_ANY,
                                       _("A basic simulator telescope"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText701->Wrap(-1);
    gbSizer51->Add(m_staticText701, wxGBPosition(0, 1), wxGBSpan(1, 1), wxALL,
                   5);
    ...
    m_staticText160 =
        new wxStaticText(m_telescope_panel, wxID_ANY, _("DriverVersion"),
                         wxDefaultPosition, wxDefaultSize, 0);
    m_staticText160->Wrap(-1);
    fgSizer311->Add(m_staticText160, 0, wxALL, 5);

    m_staticText161 =
        new wxStaticText(m_telescope_panel, wxID_ANY, _("          "),
                         wxDefaultPosition, wxDefaultSize, 0);
    m_staticText161->Wrap(-1);
    fgSizer311->Add(m_staticText161, 0, wxALL, 5);

    m_staticText162 =
        new wxStaticText(m_telescope_panel, wxID_ANY, _("DrvierInfo"),
                         wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText164 =
        new wxStaticText(m_telescope_panel, wxID_ANY, _("Longitude"),
                         wxDefaultPosition, wxDefaultSize, 0);
    m_staticText164->Wrap(-1);
    fgSizer311->Add(m_staticText164, 0, wxALL, 5);

    m_staticText165 =
        new wxStaticText(m_telescope_panel, wxID_ANY, wxEmptyString,
                         wxDefaultPosition, wxDefaultSize, 0);
    m_staticText165->Wrap(-1);
    fgSizer311->Add(m_staticText165, 0, wxALL, 5);

    m_staticText166 =
        new wxStaticText(m_telescope_panel, wxID_ANY, _("Latitude"),
                         wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText168 = new wxStaticText(m_telescope_panel, wxID_ANY, _("AZ"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText170 = new wxStaticText(m_telescope_panel, wxID_ANY, _("ALT"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText172 = new wxStaticText(m_telescope_panel, wxID_ANY, _("RA"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText174 = new wxStaticText(m_telescope_panel, wxID_ANY, _("DEC"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText176 =
        new wxStaticText(m_telescope_panel, wxID_ANY, _("Elevation"),
                         wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText178 =
        new wxStaticText(m_telescope_panel, wxID_ANY, _("Transmit"),
                         wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_button25 = new wxButton(m_telescope_panel, wxID_ANY, _("Track"),
                              wxDefaultPosition, wxDefaultSize, 0);
    fgSizer49->Add(m_button25, 0, wxALL, 5);

    m_button26 = new wxButton(m_telescope_panel, wxID_ANY, _("Home"),
                              wxDefaultPosition, wxDefaultSize, 0);
    fgSizer49->Add(m_button26, 0, wxALL, 5);

    m_button27 = new wxButton(m_telescope_panel, wxID_ANY, _("Park"),
                              wxDefaultPosition, wxDefaultSize, 0);
    fgSizer49->Add(m_button27, 0, wxALL, 5);

    m_button28 = new wxButton(m_telescope_panel, wxID_ANY, _("Random"),
                              wxDefaultPosition, wxDefaultSize, 0);
    fgSizer49->Add(m_button28, 0, wxALL, 5);

    m_button29 = new wxButton(m_telescope_panel, wxID_ANY, _("Sync"),
                              wxDefaultPosition, wxDefaultSize, 0);
    fgSizer49->Add(m_button29, 0, wxALL, 5);

    m_button30 = new wxButton(m_telescope_panel, wxID_ANY, _("GetInfo"),
                              wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText188 =
        new wxStaticText(m_telescope_panel, wxID_ANY, _("Telescope Control"),
                         wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText189 = new wxStaticText(m_telescope_panel, wxID_ANY, _("RA"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText189->Wrap(-1);
    fgSizer45->Add(m_staticText189, 0, wxALL, 5);

    m_textCtrl47 = new wxTextCtrl(m_telescope_panel, wxID_ANY, wxEmptyString,
                                  wxDefaultPosition, wxDefaultSize, 0);
#ifdef __WXGTK__
    ...
    m_staticText190 = new wxStaticText(m_telescope_panel, wxID_ANY, _("h"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText190->Wrap(-1);
    fgSizer45->Add(m_staticText190, 0, wxALL, 5);

    m_textCtrl48 = new wxTextCtrl(m_telescope_panel, wxID_ANY, wxEmptyString,
                                  wxDefaultPosition, wxDefaultSize, 0);
#ifdef __WXGTK__
    ...
    m_staticText191 = new wxStaticText(m_telescope_panel, wxID_ANY, _("m"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText191->Wrap(-1);
    fgSizer45->Add(m_staticText191, 0, wxALL, 5);

    m_textCtrl49 = new wxTextCtrl(m_telescope_panel, wxID_ANY, wxEmptyString,
                                  wxDefaultPosition, wxDefaultSize, 0);
#ifdef __WXGTK__
    ...
    m_staticText192 = new wxStaticText(m_telescope_panel, wxID_ANY, _("s"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText192->Wrap(-1);
    fgSizer45->Add(m_staticText192, 0, wxALL, 5);

    m_staticText193 = new wxStaticText(m_telescope_panel, wxID_ANY, _("DEC"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText193->Wrap(-1);
    fgSizer45->Add(m_staticText193, 0, wxALL, 5);

    m_textCtrl50 = new wxTextCtrl(m_telescope_panel, wxID_ANY, wxEmptyString,
                                  wxDefaultPosition, wxDefaultSize, 0);
#ifdef __WXGTK__
    ...
    m_staticText194 = new wxStaticText(m_telescope_panel, wxID_ANY, _("h"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText194->Wrap(-1);
    fgSizer45->Add(m_staticText194, 0, wxALL, 5);

    m_textCtrl51 = new wxTextCtrl(m_telescope_panel, wxID_ANY, wxEmptyString,
                                  wxDefaultPosition, wxDefaultSize, 0);
    m_textCtrl51->SetMaxSize(wxSize(30, -1));

    fgSizer45->Add(m_textCtrl51, 0, wxALL, 5);

    m_staticText195 = new wxStaticText(m_telescope_panel, wxID_ANY, _("m"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText195->Wrap(-1);
    fgSizer45->Add(m_staticText195, 0, wxALL, 5);

    m_textCtrl52 = new wxTextCtrl(m_telescope_panel, wxID_ANY, wxEmptyString,
                                  wxDefaultPosition, wxDefaultSize, 0);
    m_textCtrl52->SetMaxSize(wxSize(30, -1));

    fgSizer45->Add(m_textCtrl52, 0, wxALL, 5);

    m_staticText196 = new wxStaticText(m_telescope_panel, wxID_ANY, _("s"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_button23 = new wxButton(m_telescope_panel, wxID_ANY, _("MyButton"),
                              wxDefaultPosition, wxDefaultSize, 0);
    fgSizer47->Add(m_button23, 0, wxALL, 5);

    m_button24 = new wxButton(m_telescope_panel, wxID_ANY, _("MyButton"),
                              wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_bpButton28 = new wxBitmapButton(m_telescope_panel, wxID_ANY, wxNullBitmap,
                                      wxDefaultPosition, wxSize(100, 100),
                                      wxBU_AUTODRAW | 0);
    gSizer4->Add(m_bpButton28, 0, wxALL, 0);

    m_bpButton29 = new wxBitmapButton(m_telescope_panel, wxID_ANY, wxNullBitmap,
                                      wxDefaultPosition, wxSize(100, 100),
                                      wxBU_AUTODRAW | 0);
    gSizer4->Add(m_bpButton29, 0, wxALL, 0);

    m_bpButton30 = new wxBitmapButton(m_telescope_panel, wxID_ANY, wxNullBitmap,
                                      wxDefaultPosition, wxSize(100, 100),
                                      wxBU_AUTODRAW | 0);
    gSizer4->Add(m_bpButton30, 0, wxALL, 0);

    m_bpButton311 = new wxBitmapButton(m_telescope_panel, wxID_ANY,
                                       wxNullBitmap, wxDefaultPosition,
                                       wxSize(100, 100), wxBU_AUTODRAW | 0);
    gSizer4->Add(m_bpButton311, 0, wxALL, 0);

    m_bpButton32 = new wxBitmapButton(m_telescope_panel, wxID_ANY, wxNullBitmap,
                                      wxDefaultPosition, wxSize(100, 100),
                                      wxBU_AUTODRAW | 0);
    gSizer4->Add(m_bpButton32, 0, wxALL, 0);

    m_bpButton33 = new wxBitmapButton(m_telescope_panel, wxID_ANY, wxNullBitmap,
                                      wxDefaultPosition, wxSize(100, 100),
                                      wxBU_AUTODRAW | 0);
    gSizer4->Add(m_bpButton33, 0, wxALL, 0);

    m_bpButton34 = new wxBitmapButton(m_telescope_panel, wxID_ANY, wxNullBitmap,
                                      wxDefaultPosition, wxSize(100, 100),
                                      wxBU_AUTODRAW | 0);
    gSizer4->Add(m_bpButton34, 0, wxALL, 0);

    m_bpButton35 = new wxBitmapButton(m_telescope_panel, wxID_ANY, wxNullBitmap,
                                      wxDefaultPosition, wxSize(100, 100),
                                      wxBU_AUTODRAW | 0);
    gSizer4->Add(m_bpButton35, 0, wxALL, 0);

    m_bpButton36 = new wxBitmapButton(m_telescope_panel, wxID_ANY, wxNullBitmap,
                                      wxDefaultPosition, wxSize(100, 100),
                                      wxBU_AUTODRAW | 0);
    ...
    m_staticText197 = new wxStaticText(m_telescope_panel, wxID_ANY, _("RA"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText197->Wrap(-1);
    fgSizer48->Add(m_staticText197, 0, wxALL, 5);

    m_slider2 = new wxSlider(m_telescope_panel, wxID_ANY, 50, 0, 100,
                             wxDefaultPosition, wxDefaultSize, wxSL_HORIZONTAL);
    fgSizer48->Add(m_slider2, 0, wxALL, 5);

    m_staticText198 = new wxStaticText(m_telescope_panel, wxID_ANY, _("DEC"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText198->Wrap(-1);
    fgSizer48->Add(m_staticText198, 0, wxALL, 5);

    m_slider3 = new wxSlider(m_telescope_panel, wxID_ANY, 50, 0, 100,
                             wxDefaultPosition, wxDefaultSize, wxSL_HORIZONTAL);
    ...
    m_focuser_panel = new wxPanel(m_main_listbook, wxID_ANY, wxDefaultPosition,
                                  wxDefaultSize, wxTAB_TRAVERSAL);
    wxBoxSizer* bSizer13;
    ...
    m_staticText201 = new wxStaticText(m_focuser_panel, wxID_ANY, _("Focuser"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText201->Wrap(-1);
    fgSizer50->Add(m_staticText201, 0, wxALL, 5);

    wxArrayString m_choice11Choices;
    m_choice11 = new wxChoice(m_focuser_panel, wxID_ANY, wxDefaultPosition,
                              wxDefaultSize, m_choice11Choices, 0);
    m_choice11->SetSelection(0);
    fgSizer50->Add(m_choice11, 0, wxALL, 5);

    m_bpButton37 =
        new wxBitmapButton(m_focuser_panel, wxID_ANY, wxNullBitmap,
                           wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW | 0);
    ...
    m_staticline25 =
        new wxStaticLine(m_focuser_panel, wxID_ANY, wxDefaultPosition,
                         wxDefaultSize, wxLI_HORIZONTAL);
    ...
    m_staticText202 = new wxStaticText(m_focuser_panel, wxID_ANY, _("MyLabel"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText202->Wrap(-1);
    fgSizer51->Add(m_staticText202, 0, wxALL, 5);

    m_staticText203 = new wxStaticText(m_focuser_panel, wxID_ANY, _("MyLabel"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText203->Wrap(-1);
    fgSizer51->Add(m_staticText203, 0, wxALL, 5);

    m_staticText204 = new wxStaticText(m_focuser_panel, wxID_ANY, _("MyLabel"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText204->Wrap(-1);
    fgSizer51->Add(m_staticText204, 0, wxALL, 5);

    m_staticText205 = new wxStaticText(m_focuser_panel, wxID_ANY, _("MyLabel"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText205->Wrap(-1);
    fgSizer51->Add(m_staticText205, 0, wxALL, 5);

    m_staticText206 = new wxStaticText(m_focuser_panel, wxID_ANY, _("MyLabel"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText206->Wrap(-1);
    fgSizer51->Add(m_staticText206, 0, wxALL, 5);

    m_staticText207 = new wxStaticText(m_focuser_panel, wxID_ANY, _("MyLabel"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText207->Wrap(-1);
    fgSizer51->Add(m_staticText207, 0, wxALL, 5);

    m_staticText208 = new wxStaticText(m_focuser_panel, wxID_ANY, _("MyLabel"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText208->Wrap(-1);
    fgSizer51->Add(m_staticText208, 0, wxALL, 5);

    m_staticText209 = new wxStaticText(m_focuser_panel, wxID_ANY, _("MyLabel"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText209->Wrap(-1);
    fgSizer51->Add(m_staticText209, 0, wxALL, 5);

    m_staticText210 = new wxStaticText(m_focuser_panel, wxID_ANY, _("MyLabel"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText210->Wrap(-1);
    fgSizer51->Add(m_staticText210, 0, wxALL, 5);

    m_staticText211 = new wxStaticText(m_focuser_panel, wxID_ANY, _("MyLabel"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText211->Wrap(-1);
    fgSizer51->Add(m_staticText211, 0, wxALL, 5);

    m_staticText212 = new wxStaticText(m_focuser_panel, wxID_ANY, _("MyLabel"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText212->Wrap(-1);
    fgSizer51->Add(m_staticText212, 0, wxALL, 5);

    m_staticText213 = new wxStaticText(m_focuser_panel, wxID_ANY, _("MyLabel"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText213->Wrap(-1);
    fgSizer51->Add(m_staticText213, 0, wxALL, 5);

    m_staticText214 = new wxStaticText(m_focuser_panel, wxID_ANY, _("MyLabel"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText214->Wrap(-1);
    fgSizer51->Add(m_staticText214, 0, wxALL, 5);

    m_staticText215 = new wxStaticText(m_focuser_panel, wxID_ANY, _("MyLabel"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText215->Wrap(-1);
    fgSizer51->Add(m_staticText215, 0, wxALL, 5);

    m_staticText216 = new wxStaticText(m_focuser_panel, wxID_ANY, _("MyLabel"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText216->Wrap(-1);
    fgSizer51->Add(m_staticText216, 0, wxALL, 5);

    m_staticText217 = new wxStaticText(m_focuser_panel, wxID_ANY, _("MyLabel"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText223 = new wxStaticText(m_focuser_panel, wxID_ANY, _("MyLabel"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText223->Wrap(-1);
    fgSizer56->Add(m_staticText223, 0, wxALL, 5);

    m_checkBox6 = new wxCheckBox(m_focuser_panel, wxID_ANY, _("Check Me!"),
                                 wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText224 = new wxStaticText(m_focuser_panel, wxID_ANY, _("MyLabel"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText224->Wrap(-1);
    fgSizer57->Add(m_staticText224, 0, wxALL, 5);

    m_textCtrl59 = new wxTextCtrl(m_focuser_panel, wxID_ANY, wxEmptyString,
                                  wxDefaultPosition, wxDefaultSize, 0);
#ifdef __WXGTK__
    ...
    m_button31 = new wxButton(m_focuser_panel, wxID_ANY, _("<<"),
                              wxDefaultPosition, wxDefaultSize, 0);
    fgSizer55->Add(m_button31, 0, wxALL, 5);

    m_button32 = new wxButton(m_focuser_panel, wxID_ANY, _("<"),
                              wxDefaultPosition, wxDefaultSize, 0);
    fgSizer55->Add(m_button32, 0, wxALL, 5);

    m_button33 = new wxButton(m_focuser_panel, wxID_ANY, _(">"),
                              wxDefaultPosition, wxDefaultSize, 0);
    fgSizer55->Add(m_button33, 0, wxALL, 5);

    m_button34 = new wxButton(m_focuser_panel, wxID_ANY, _(">>"),
                              wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText218 =
        new wxStaticText(m_focuser_panel, wxID_ANY, _("Focuser Settings"),
                         wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText219 = new wxStaticText(m_focuser_panel, wxID_ANY, _("MyLabel"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText219->Wrap(-1);
    fgSizer54->Add(m_staticText219, 0, wxALL, 5);

    m_textCtrl55 = new wxTextCtrl(m_focuser_panel, wxID_ANY, wxEmptyString,
                                  wxDefaultPosition, wxDefaultSize, 0);
    fgSizer54->Add(m_textCtrl55, 0, wxALL, 5);

    m_staticText220 = new wxStaticText(m_focuser_panel, wxID_ANY, _("MyLabel"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText220->Wrap(-1);
    fgSizer54->Add(m_staticText220, 0, wxALL, 5);

    m_textCtrl56 = new wxTextCtrl(m_focuser_panel, wxID_ANY, wxEmptyString,
                                  wxDefaultPosition, wxDefaultSize, 0);
    fgSizer54->Add(m_textCtrl56, 0, wxALL, 5);

    m_staticText221 = new wxStaticText(m_focuser_panel, wxID_ANY, _("MyLabel"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText221->Wrap(-1);
    fgSizer54->Add(m_staticText221, 0, wxALL, 5);

    m_textCtrl57 = new wxTextCtrl(m_focuser_panel, wxID_ANY, wxEmptyString,
                                  wxDefaultPosition, wxDefaultSize, 0);
    fgSizer54->Add(m_textCtrl57, 0, wxALL, 5);

    m_staticText222 = new wxStaticText(m_focuser_panel, wxID_ANY, _("MyLabel"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText222->Wrap(-1);
    fgSizer54->Add(m_staticText222, 0, wxALL, 5);

    m_textCtrl58 = new wxTextCtrl(m_focuser_panel, wxID_ANY, wxEmptyString,
                                  wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText3211 =
        new wxStaticText(m_filterwheel_panel, wxID_ANY, _("Telescope"),
                         wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_choice411 =
        new wxChoice(m_filterwheel_panel, wxID_ANY, wxDefaultPosition,
                     wxDefaultSize, m_choice411NChoices, m_choice411Choices, 0);
    m_choice411->SetSelection(0);
    fgSizer2411->Add(m_choice411, 0, wxALL, 5);

    m_bpButton211 =
        new wxBitmapButton(m_filterwheel_panel, wxID_ANY, wxNullBitmap,
                           wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW | 0);
    ...
    m_staticline1111 =
        new wxStaticLine(m_filterwheel_panel, wxID_ANY, wxDefaultPosition,
                         wxDefaultSize, wxLI_HORIZONTAL);
    ...
    m_staticText7111 =
        new wxStaticText(m_filterwheel_panel, wxID_ANY, _("Name"),
                         wxDefaultPosition, wxDefaultSize, 0);
    m_staticText7111->Wrap(-1);
    gbSizer311->Add(m_staticText7111, wxGBPosition(0, 0), wxGBSpan(1, 1), wxALL,
                    5);

    m_staticText7211 =
        new wxStaticText(m_filterwheel_panel, wxID_ANY, _("Simulator"),
                         wxDefaultPosition, wxDefaultSize, 0);
    m_staticText7211->Wrap(-1);
    gbSizer311->Add(m_staticText7211, wxGBPosition(0, 1), wxGBSpan(1, 1), wxALL,
                    5);
    ...
    m_staticText6911 =
        new wxStaticText(m_filterwheel_panel, wxID_ANY, _("Description"),
                         wxDefaultPosition, wxDefaultSize, 0);
    m_staticText6911->Wrap(-1);
    gbSizer511->Add(m_staticText6911, wxGBPosition(0, 0), wxGBSpan(1, 1), wxALL,
                    5);

    m_staticText7011 = new wxStaticText(m_filterwheel_panel, wxID_ANY,
                                        _("A basic simulator telescope"),
                                        wxDefaultPosition, wxDefaultSize, 0);
    m_staticText7011->Wrap(-1);
    gbSizer511->Add(m_staticText7011, wxGBPosition(0, 1), wxGBSpan(1, 1), wxALL,
                    5);
    ...
    m_staticText297 =
        new wxStaticText(m_filterwheel_panel, wxID_ANY, _("DriverVersion"),
                         wxDefaultPosition, wxDefaultSize, 0);
    m_staticText297->Wrap(-1);
    fgSizer76->Add(m_staticText297, 0, wxALL, 5);

    m_staticText298 =
        new wxStaticText(m_filterwheel_panel, wxID_ANY, wxEmptyString,
                         wxDefaultPosition, wxDefaultSize, 0);
    m_staticText298->Wrap(-1);
    fgSizer76->Add(m_staticText298, 0, wxALL, 5);

    m_staticText299 =
        new wxStaticText(m_filterwheel_panel, wxID_ANY, _("DrvierInfo"),
                         wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText306 =
        new wxStaticText(m_filterwheel_panel, wxID_ANY, _("Position"),
                         wxDefaultPosition, wxDefaultSize, 0);
    m_staticText306->Wrap(-1);
    fgSizer77->Add(m_staticText306, 0, wxALL, 5);

    m_comboBox1 = new wxComboBox(m_filterwheel_panel, wxID_ANY, _("Combo!"),
                                 wxDefaultPosition, wxDefaultSize, 0, NULL, 0);
    fgSizer77->Add(m_comboBox1, 0, wxALL, 5);

    m_button51 = new wxButton(m_filterwheel_panel, wxID_ANY, _("MoveTo"),
                              wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_grid3 = new wxGrid(m_filterwheel_panel, wxID_ANY, wxDefaultPosition,
                         wxDefaultSize, 0);
    ...
    m_guider_panel = new wxPanel(m_main_listbook, wxID_ANY, wxDefaultPosition,
                                 wxDefaultSize, wxTAB_TRAVERSAL);
    m_main_listbook->AddPage(m_guider_panel, _("Guider"), false);
    m_plugin_panel = new wxPanel(m_main_listbook, wxID_ANY, wxDefaultPosition,
                                 wxDefaultSize, wxTAB_TRAVERSAL);
    wxBoxSizer* bSizer20;
    bSizer20 = new wxBoxSizer(wxVERTICAL);

    m_listbook3 = new wxListbook(m_plugin_panel, wxID_ANY, wxDefaultPosition,
                                 wxDefaultSize, wxLB_DEFAULT);
    m_plugin_installed_panel =
        new wxPanel(m_listbook3, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                    wxTAB_TRAVERSAL);
    wxBoxSizer* bSizer21;
    bSizer21 = new wxBoxSizer(wxVERTICAL);

    m_listbook4 =
        new wxListbook(m_plugin_installed_panel, wxID_ANY, wxDefaultPosition,
                       wxDefaultSize, wxLB_DEFAULT);
    m_pulgin_panel_openapt =
        new wxPanel(m_listbook4, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                    wxTAB_TRAVERSAL);
    ...
    m_plugin_download_panel =
        new wxPanel(m_listbook3, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                    wxTAB_TRAVERSAL);
    m_listbook3->AddPage(m_plugin_download_panel, _("Download"), false);
    m_plugin_local_panel = new wxPanel(m_listbook3, wxID_ANY, wxDefaultPosition,
                                       wxDefaultSize, wxTAB_TRAVERSAL);
    wxBoxSizer* bSizer23;
    ...
    m_staticText307 = new wxStaticText(m_plugin_local_panel, wxID_ANY,
                                       _("Local Modules Installer"),
                                       wxDefaultPosition, wxDefaultSize, 0);
    m_staticText307->Wrap(-1);
    fgSizer81->Add(m_staticText307, 0, wxALL, 5);

    m_staticline44 =
        new wxStaticLine(m_plugin_local_panel, wxID_ANY, wxDefaultPosition,
                         wxDefaultSize, wxLI_HORIZONTAL);
    ...
    m_button52 = new wxButton(m_plugin_local_panel, wxID_ANY, _("Refresh"),
                              wxDefaultPosition, wxDefaultSize, 0);
    fgSizer80->Add(m_button52, 0, wxALL, 5);

    m_searchCtrl1 =
        new wxSearchCtrl(m_plugin_local_panel, wxID_ANY, wxEmptyString,
                         wxDefaultPosition, wxDefaultSize, 0);
#ifndef __WXMAC__
    ...
    m_button53 = new wxButton(m_plugin_local_panel, wxID_ANY, _("Search"),
                              wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_listbook5 =
        new wxListbook(m_plugin_local_panel, wxID_ANY, wxDefaultPosition,
                       wxDefaultSize, wxLB_DEFAULT);
#ifdef __WXGTK__  // Small icon style not supported in GTK
    ...
    m_server_panel = new wxPanel(m_main_listbook, wxID_ANY, wxDefaultPosition,
                                 wxDefaultSize, wxTAB_TRAVERSAL);
    ...
    m_settings_panel = new wxPanel(m_main_listbook, wxID_ANY, wxDefaultPosition,
                                   wxDefaultSize, wxTAB_TRAVERSAL);
    ...
    if (m_main_listbookFlags & wxLC_SMALL_ICON) {
        m_main_listbookFlags =
            (m_main_listbookFlags & ~wxLC_SMALL_ICON) | wxLC_ICON;
    }
    ...
    // Connect Events
    m_camera_settings_btn->Connect(
        wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(DeviceDialog::on_camera_settings_click), NULL,
        this);
    m_camera_connect_btn->Connect(
        wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(DeviceDialog::on_camera_connect_click), NULL,
        this);
    m_camera_scan_btn->Connect(
        wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(DeviceDialog::on_camera_scan_click), NULL, this);
...
DeviceDialog::~DeviceDialog() {
    // Disconnect Events
    m_camera_settings_btn->Disconnect(
        wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(DeviceDialog::on_camera_settings_click), NULL,
        this);
    m_camera_connect_btn->Disconnect(
        wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(DeviceDialog::on_camera_connect_click), NULL,
        this);
    m_camera_scan_btn->Disconnect(
        wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(DeviceDialog::on_camera_scan_click), NULL, this);
