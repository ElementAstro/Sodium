...
SolverAssistant::SolverAssistant(wxWindow* parent, wxWindowID id,
    ...
    m_solver_exe = new wxFilePickerCtrl(
        this, wxID_ANY, wxEmptyString, _("Select a file"), _("*.*"),
    ...
    int m_solver_choiceNChoices =
        sizeof(m_solver_choiceChoices) / sizeof(wxString);
    m_solver_choice =
        new wxChoice(this, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                     m_solver_choiceNChoices, m_solver_choiceChoices, 0);
    m_solver_choice->SetSelection(1);
    m_solver_solver_sizer->Add(m_solver_choice, 0, wxALL, 5);

    m_solver_search = new wxButton(this, wxID_ANY, _("Search"),
    ...
    m_solver_settings_panel = new wxCollapsiblePane(
        this, wxID_ANY, _("Solver Settings"), wxDefaultPosition, wxDefaultSize,
        wxCP_DEFAULT_STYLE);
    ...
    m_solver_settings_sizer_2->SetNonFlexibleGrowMode(
        wxFLEX_GROWMODE_SPECIFIED);

    m_solver_settings_ra_t =
        new wxStaticText(m_solver_settings_panel->GetPane(), wxID_ANY, _("RA"),
                         wxDefaultPosition, wxDefaultSize, 0);
    m_solver_settings_ra_t->Wrap(-1);
    m_solver_settings_sizer_2->Add(m_solver_settings_ra_t, 0, wxALL, 5);

    m_solver_settings_ra =
        new wxTextCtrl(m_solver_settings_panel->GetPane(), wxID_ANY,
    ...
    m_solver_settings_dec_t =
        new wxStaticText(m_solver_settings_panel->GetPane(), wxID_ANY, _("DEC"),
                         wxDefaultPosition, wxDefaultSize, 0);
    m_solver_settings_dec_t->Wrap(-1);
    m_solver_settings_sizer_2->Add(m_solver_settings_dec_t, 0, wxALL, 5);

    m_solver_settings_dec =
        new wxTextCtrl(m_solver_settings_panel->GetPane(), wxID_ANY,
                       wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
#ifdef __WXGTK__
    ...
    m_solver_settings_fov_t =
        new wxStaticText(m_solver_settings_panel->GetPane(), wxID_ANY, _("Fov"),
                         wxDefaultPosition, wxDefaultSize, 0);
    m_solver_settings_fov_t->Wrap(-1);
    m_solver_settings_sizer_2->Add(m_solver_settings_fov_t, 0, wxALL, 5);

    m_solver_settings_fov =
        new wxTextCtrl(m_solver_settings_panel->GetPane(), wxID_ANY,
                       wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
#ifdef __WXGTK__
    ...
    m_solver_settings_downsample_t =
        new wxStaticText(m_solver_settings_panel->GetPane(), wxID_ANY,
                         _("Downsample"), wxDefaultPosition, wxDefaultSize, 0);
    m_solver_settings_downsample_t->Wrap(-1);
    m_solver_settings_sizer_2->Add(m_solver_settings_downsample_t, 0, wxALL, 5);

    wxString m_solver_settings_downsampleChoices[] = {_("Auto"), _("1"), _("2"),
                                                      _("4")};
    int m_solver_settings_downsampleNChoices =
        sizeof(m_solver_settings_downsampleChoices) / sizeof(wxString);
    m_solver_settings_downsample = new wxChoice(
        m_solver_settings_panel->GetPane(), wxID_ANY, wxDefaultPosition,
        wxDefaultSize, m_solver_settings_downsampleNChoices,
        m_solver_settings_downsampleChoices, 0);
    ...
    m_solver_template_panel = new wxCollapsiblePane(
        this, wxID_ANY, _("Template Download"), wxDefaultPosition,
    ...
    m_solver_template_choice = new wxChoice(
        m_solver_template_panel->GetPane(), wxID_ANY, wxDefaultPosition,
        wxDefaultSize, m_solver_template_choiceChoices, 0);
    m_solver_template_choice->SetSelection(0);
    fgSizer11->Add(m_solver_template_choice, 0, wxALL, 5);

    m_solver_template_refresh =
        new wxButton(m_solver_template_panel->GetPane(), wxID_ANY, _("Refresh"),
                     wxDefaultPosition, wxDefaultSize, 0);
    fgSizer11->Add(m_solver_template_refresh, 0, wxALL, 5);

    m_solver_template_download =
        new wxButton(m_solver_template_panel->GetPane(), wxID_ANY,
                     _("Download"), wxDefaultPosition, wxDefaultSize, 0);
    fgSizer11->Add(m_solver_template_download, 0, wxALL, 5);

    m_solver_template_open =
        new wxButton(m_solver_template_panel->GetPane(), wxID_ANY, _("Open"),
                     wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticline5 = new wxStaticLine(this, wxID_ANY, wxDefaultPosition,
                                     wxDefaultSize, wxLI_HORIZONTAL);
    ...
    m_solver_result_panel =
        new wxCollapsiblePane(this, wxID_ANY, _("Result"), wxDefaultPosition,
                              wxDefaultSize, wxCP_DEFAULT_STYLE);
    ...
    m_solver_result_ra_t =
        new wxStaticText(m_solver_result_panel->GetPane(), wxID_ANY,
                         _("RA     "), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_solver_result_ra = new wxStaticText(m_solver_result_panel->GetPane(),
                                          wxID_ANY, _("               "),
                                          wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_solver_result_dec_sizer->SetNonFlexibleGrowMode(
        wxFLEX_GROWMODE_SPECIFIED);

    m_solver_result_dec_t =
        new wxStaticText(m_solver_result_panel->GetPane(), wxID_ANY, _("DEC"),
                         wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_solver_result_rotation_sizer->SetNonFlexibleGrowMode(
        wxFLEX_GROWMODE_SPECIFIED);

    m_solver_result_ratation_t =
        new wxStaticText(m_solver_result_panel->GetPane(), wxID_ANY,
                         _("Rotation"), wxDefaultPosition, wxDefaultSize, 0);
    m_solver_result_ratation_t->Wrap(-1);
    m_solver_result_rotation_sizer->Add(m_solver_result_ratation_t, 0, wxALL,
                                        5);

    m_solver_result_ratation =
        new wxStaticText(m_solver_result_panel->GetPane(), wxID_ANY,
                         wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
    m_solver_result_ratation->Wrap(-1);
    m_solver_result_rotation_sizer->Add(m_solver_result_ratation, 0, wxALL, 5);

    m_solver_result_radec_sizer->Add(m_solver_result_rotation_sizer, 1,
                                     wxEXPAND, 5);
    ...
    m_solver_result_fovx_sizer->SetNonFlexibleGrowMode(
        wxFLEX_GROWMODE_SPECIFIED);

    m_solver_result_fovx_t =
        new wxStaticText(m_solver_result_panel->GetPane(), wxID_ANY,
                         _("Fov(x)"), wxDefaultPosition, wxDefaultSize, 0);
    m_solver_result_fovx_t->Wrap(-1);
    m_solver_result_fovx_sizer->Add(m_solver_result_fovx_t, 0, wxALL, 5);

    m_solver_result_fovx =
        new wxStaticText(m_solver_result_panel->GetPane(), wxID_ANY,
                         wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
    m_solver_result_fovx->Wrap(-1);
    m_solver_result_fovx_sizer->Add(m_solver_result_fovx, 0, wxALL, 5);

    m_solver_result_radec_sizer->Add(m_solver_result_fovx_sizer, 1, wxEXPAND,
                                     5);
    ...
    m_solver_result_fovy_sizer->SetNonFlexibleGrowMode(
        wxFLEX_GROWMODE_SPECIFIED);

    m_solver_result_fovy_t =
        new wxStaticText(m_solver_result_panel->GetPane(), wxID_ANY,
                         _("Fov(y)"), wxDefaultPosition, wxDefaultSize, 0);
    m_solver_result_fovy_t->Wrap(-1);
    m_solver_result_fovy_sizer->Add(m_solver_result_fovy_t, 0, wxALL, 5);

    m_solver_result_fovy =
        new wxStaticText(m_solver_result_panel->GetPane(), wxID_ANY,
                         wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
    m_solver_result_fovy->Wrap(-1);
    m_solver_result_fovy_sizer->Add(m_solver_result_fovy, 0, wxALL, 5);

    m_solver_result_radec_sizer->Add(m_solver_result_fovy_sizer, 1, wxEXPAND,
                                     5);
    ...
    // Connect Events
    m_solver_exe->Connect(
        wxEVT_COMMAND_FILEPICKER_CHANGED,
        wxFileDirPickerEventHandler(SolverAssistant::on_solver_changed), NULL,
        this);
    m_solver_search->Connect(
        wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(SolverAssistant::on_solver_search), NULL, this);
    m_solver_settings_ra_t->Connect(
        wxEVT_LEFT_DCLICK,
        wxMouseEventHandler(SolverAssistant::refresh_solver_ra), NULL, this);
    m_solver_settings_ra->Connect(
        wxEVT_COMMAND_TEXT_UPDATED,
        wxCommandEventHandler(SolverAssistant::on_ra_enter), NULL, this);
    m_solver_settings_dec_t->Connect(
        wxEVT_LEFT_DCLICK,
        wxMouseEventHandler(SolverAssistant::refresh_solver_dec), NULL, this);
    m_solver_settings_dec->Connect(
        wxEVT_COMMAND_TEXT_UPDATED,
        wxCommandEventHandler(SolverAssistant::on_dec_enter), NULL, this);
    m_solver_settings_fov->Connect(
        wxEVT_COMMAND_TEXT_UPDATED,
        wxCommandEventHandler(SolverAssistant::on_fov_enter), NULL, this);
    m_solver_template_choice->Connect(
        wxEVT_COMMAND_CHOICE_SELECTED,
        wxCommandEventHandler(SolverAssistant::check_template_downloaded), NULL,
        this);
    m_solver_template_refresh->Connect(
        wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(SolverAssistant::on_refresh_template), NULL,
        this);
    m_solver_template_download->Connect(
        wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(SolverAssistant::on_download_template), NULL,
        this);
    m_solver_template_open->Connect(
        wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(SolverAssistant::on_open_template_folder), NULL,
        this);
    m_solver_start->Connect(
        wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(SolverAssistant::on_start_solver), NULL, this);
    m_solver_stop->Connect(
        wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(SolverAssistant::on_stop_solver), NULL, this);
    m_solver_copy->Connect(
        wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(SolverAssistant::on_copy_solver), NULL, this);
    m_solver_exit->Connect(
        wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(SolverAssistant::on_exit_solver), NULL, this);
    m_solver_help->Connect(
        wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(SolverAssistant::on_help_solver), NULL, this);
    m_solver_result_ra_t->Connect(
        wxEVT_LEFT_DCLICK,
        wxMouseEventHandler(SolverAssistant::on_copy_solver_result_ra), NULL,
        this);
    m_solver_result_ra->Connect(
        wxEVT_LEFT_DCLICK,
        wxMouseEventHandler(SolverAssistant::on_copy_solver_result_ra), NULL,
        this);
    m_solver_result_dec_t->Connect(
        wxEVT_LEFT_DCLICK,
        wxMouseEventHandler(SolverAssistant::on_copy_solver_result_dec), NULL,
        this);
    m_solver_result_dec->Connect(
        wxEVT_LEFT_DCLICK,
        wxMouseEventHandler(SolverAssistant::on_copy_solver_result_dec), NULL,
        this);
    m_solver_result_ratation_t->Connect(
        wxEVT_LEFT_DCLICK,
        wxMouseEventHandler(SolverAssistant::on_copy_solver_result_rotation),
        NULL, this);
    m_solver_result_ratation->Connect(
        wxEVT_LEFT_DCLICK,
        wxMouseEventHandler(SolverAssistant::on_copy_solver_result_rotation),
        NULL, this);
    m_solver_result_fovx_t->Connect(
        wxEVT_LEFT_DCLICK,
        wxMouseEventHandler(SolverAssistant::on_copy_solver_result_fovx), NULL,
        this);
    m_solver_result_fovx->Connect(
        wxEVT_LEFT_DCLICK,
        wxMouseEventHandler(SolverAssistant::on_copy_solver_result_fovx), NULL,
        this);
    m_solver_result_fovy_t->Connect(
        wxEVT_LEFT_DCLICK,
        wxMouseEventHandler(SolverAssistant::on_copy_solver_result_fovy), NULL,
        this);
    m_solver_result_fovy->Connect(
        wxEVT_LEFT_DCLICK,
        wxMouseEventHandler(SolverAssistant::on_copy_solver_result_fovy), NULL,
        this);
}
...
SolverAssistant::~SolverAssistant() {
    // Disconnect Events
    m_solver_exe->Disconnect(
        wxEVT_COMMAND_FILEPICKER_CHANGED,
        wxFileDirPickerEventHandler(SolverAssistant::on_solver_changed), NULL,
        this);
    m_solver_search->Disconnect(
        wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(SolverAssistant::on_solver_search), NULL, this);
    m_solver_settings_ra_t->Disconnect(
        wxEVT_LEFT_DCLICK,
        wxMouseEventHandler(SolverAssistant::refresh_solver_ra), NULL, this);
    m_solver_settings_ra->Disconnect(
        wxEVT_COMMAND_TEXT_UPDATED,
        wxCommandEventHandler(SolverAssistant::on_ra_enter), NULL, this);
    m_solver_settings_dec_t->Disconnect(
        wxEVT_LEFT_DCLICK,
        wxMouseEventHandler(SolverAssistant::refresh_solver_dec), NULL, this);
    m_solver_settings_dec->Disconnect(
        wxEVT_COMMAND_TEXT_UPDATED,
        wxCommandEventHandler(SolverAssistant::on_dec_enter), NULL, this);
    m_solver_settings_fov->Disconnect(
        wxEVT_COMMAND_TEXT_UPDATED,
        wxCommandEventHandler(SolverAssistant::on_fov_enter), NULL, this);
    m_solver_template_choice->Disconnect(
        wxEVT_COMMAND_CHOICE_SELECTED,
        wxCommandEventHandler(SolverAssistant::check_template_downloaded), NULL,
        this);
    m_solver_template_refresh->Disconnect(
        wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(SolverAssistant::on_refresh_template), NULL,
        this);
    m_solver_template_download->Disconnect(
        wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(SolverAssistant::on_download_template), NULL,
        this);
    m_solver_template_open->Disconnect(
        wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(SolverAssistant::on_open_template_folder), NULL,
        this);
    m_solver_start->Disconnect(
        wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(SolverAssistant::on_start_solver), NULL, this);
    m_solver_stop->Disconnect(
        wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(SolverAssistant::on_stop_solver), NULL, this);
    m_solver_copy->Disconnect(
        wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(SolverAssistant::on_copy_solver), NULL, this);
    m_solver_exit->Disconnect(
        wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(SolverAssistant::on_exit_solver), NULL, this);
    m_solver_help->Disconnect(
        wxEVT_COMMAND_BUTTON_CLICKED,
        wxCommandEventHandler(SolverAssistant::on_help_solver), NULL, this);
    m_solver_result_ra_t->Disconnect(
        wxEVT_LEFT_DCLICK,
        wxMouseEventHandler(SolverAssistant::on_copy_solver_result_ra), NULL,
        this);
    m_solver_result_ra->Disconnect(
        wxEVT_LEFT_DCLICK,
        wxMouseEventHandler(SolverAssistant::on_copy_solver_result_ra), NULL,
        this);
    m_solver_result_dec_t->Disconnect(
        wxEVT_LEFT_DCLICK,
        wxMouseEventHandler(SolverAssistant::on_copy_solver_result_dec), NULL,
        this);
    m_solver_result_dec->Disconnect(
        wxEVT_LEFT_DCLICK,
        wxMouseEventHandler(SolverAssistant::on_copy_solver_result_dec), NULL,
        this);
    m_solver_result_ratation_t->Disconnect(
        wxEVT_LEFT_DCLICK,
        wxMouseEventHandler(SolverAssistant::on_copy_solver_result_rotation),
        NULL, this);
    m_solver_result_ratation->Disconnect(
        wxEVT_LEFT_DCLICK,
        wxMouseEventHandler(SolverAssistant::on_copy_solver_result_rotation),
        NULL, this);
    m_solver_result_fovx_t->Disconnect(
        wxEVT_LEFT_DCLICK,
        wxMouseEventHandler(SolverAssistant::on_copy_solver_result_fovx), NULL,
        this);
    m_solver_result_fovx->Disconnect(
        wxEVT_LEFT_DCLICK,
        wxMouseEventHandler(SolverAssistant::on_copy_solver_result_fovx), NULL,
        this);
    m_solver_result_fovy_t->Disconnect(
        wxEVT_LEFT_DCLICK,
        wxMouseEventHandler(SolverAssistant::on_copy_solver_result_fovy), NULL,
        this);
    m_solver_result_fovy->Disconnect(
        wxEVT_LEFT_DCLICK,
        wxMouseEventHandler(SolverAssistant::on_copy_solver_result_fovy), NULL,
        this);
}
