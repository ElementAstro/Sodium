...
void LightGuiderSolverAssistant::on_solver_changed(
...
void LightGuiderSolverAssistant::check_template_downloaded(
...
void LightGuiderSolverAssistant::on_open_template_folder(
    wxCommandEvent& event) {
...
void LightGuiderSolverAssistant::on_copy_solver_result_dec(
    wxMouseEvent& event) {
    // TODO: Implement on_copy_solver_result_dec
}

void LightGuiderSolverAssistant::on_copy_solver_result_rotation(
    wxMouseEvent& event) {
    // TODO: Implement on_copy_solver_result_rotation
}

void LightGuiderSolverAssistant::on_copy_solver_result_fovx(
    wxMouseEvent& event) {
    // TODO: Implement on_copy_solver_result_fovx
}

void LightGuiderSolverAssistant::on_copy_solver_result_fovy(
    wxMouseEvent& event) {
