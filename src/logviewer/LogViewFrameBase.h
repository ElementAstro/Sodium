...
public:
    LogViewFrameBase(wxWindow* parent, wxWindowID id = wxID_ANY,
                     const wxString& title = wxEmptyString,
                     const wxPoint& pos = wxDefaultPosition,
                     const wxSize& size = wxSize(970, 599),
...
public:
    HelpDialogBase(wxWindow* parent, wxWindowID id = wxID_ANY,
                   const wxString& title = wxT("LGuider Log Viewer Quick Help"),
                   const wxPoint& pos = wxDefaultPosition,
                   const wxSize& size = wxSize(567, 523),
...
public:
    ...
    AnalyzeFrameBase(wxWindow* parent, wxWindowID id = wxID_ANY,
                     const wxString& title = wxT("Analysis"),
                     const wxPoint& pos = wxDefaultPosition,
                     const wxSize& size = wxSize(949, 540),
                     long style = wxDEFAULT_FRAME_STYLE | wxTAB_TRAVERSAL);
...
protected:
public:
    MyFrame5(wxWindow* parent, wxWindowID id = wxID_ANY,
             const wxString& title = wxEmptyString,
             const wxPoint& pos = wxDefaultPosition,
